...
describe('CampaignHeader — Active Session Display', () => {
  ...
  it('shows active session name and gear icon when isOwner=true and activeSessionName provided', () => {
    render(
      <CampaignHeader
        campaignId="camp-1"
        isOwner={true}
  ...
  it('shows "No Session" when isOwner=true but no activeSessionName', () => {
    render(
      <CampaignHeader
        campaignId="camp-1"
        isOwner={true}
