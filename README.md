...
app/
  ...
  components/
    PixelButton.tsx       # Retro 8-bit button component
  ...
  utils/
    ...
    posthog-client.ts     # Client-side analytics helpers
  routes/
  ...
  server/
    ...
    utils/
      helpers.ts          # Server utilities (invite codes, image upload, validation)
      oauth.ts            # OAuth provider implementations
      posthog.ts          # Server-side analytics

docs/
  deployment.md           # Full deployment & infrastructure guide
